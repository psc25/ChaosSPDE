...
for i in range(ep):
    ...
    for j in range(nrbatch):
        ...
        feed_dict = {xi_alpha_tf: xi_alpha[:, ind_batch], tt1_tf: tt1, uu1_tf: uu1, W_tf: W[:, ind_batch]}
    ...
    if (i+1) % eval_every == 0:
        begin = time.time()
        feed_dict = {xi_alpha_tf: xi_alpha[:, ind_test], tt1_tf: tt1, uu1_tf: uu1, W_tf: W[:, ind_test]}
        ...
        feed_dict = {xi_alpha_tf: xi_alpha[:, ind_plot:(ind_plot+1)], tt1_tf: tt1, uu1_tf: uuplot, W_tf: W[:, ind_plot:(ind_plot+1)]}
